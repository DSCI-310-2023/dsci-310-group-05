...
doc <- "This script downloads the data from the internet. Column names are 
added to the dataset as there was none and then, it is saved locally.

Usage: src/load-data.R --url=<url> --dest_raw_data=<file_path>

Options:
    --url=<url>                       Url to download data
    --dest_raw_data=<file_path>       Path to where the raw_data will be saved
                                      (including filename)
    "
