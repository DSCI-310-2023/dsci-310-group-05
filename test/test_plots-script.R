...
test_that("horizontal_hist produces a plot", {
  plot <- horizontal_hist(test_data_1, "x", "y", "x", "y", "Test Plot", plot_width = 6, plot_height = 4)
...
test_that("scatterplot produces a plot", {
  plot <- scatterplot(test_data_1, "x", "y", "color", "x", "y", "Color", "Test Plot", plot_width = 6, plot_height = 4)
  expect_true(is.ggplot(plot))
})
...
test_that("accuracy_plot produces a plot", {
  plot <- accuracy_plot(test_data_2, x_label = "Neighbors", y_label = "Mean", plot_title = "Accuracy Plot")
  expect_true(is.ggplot(plot))
})
