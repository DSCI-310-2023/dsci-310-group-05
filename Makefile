...
# Modelling
data/drugs_workflow_data.csv data/standardized_training_data.csv: src/modelling.R
	Rscript src/modelling.R --training_data_path=data/training_data.csv --testing_data_path=data/testing_data.csv --dest_std_training_data=data/standardized_training_data.csv --dest_workflow_data=data/drugs_workflow_data.csv --fig_out_dir=results/neighbors_and_accuracy_graph.png --dest_results_data=results_data.csv 
...
clean:
	rm -rf results
	#rm -rf data
	rm -rf doc/Cannabis-Use-Prediction_Analysis.html 
