...
data/training_data.csv data/testing_data.csv: src/pre-processing.R 
	Rscript src/pre-processing.R --file_path=data/drug_consumption.csv --strata_variable="Cannabis" --predictor_variable="Nicotine" --dest_test_path=data/testing_data.csv --dest_train_path=data/training_data.csv --dest_processed_data=data/processed_training_data.csv
